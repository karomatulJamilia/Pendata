...
### 1. Latar Belakang
    ...
    Data mining hadir sebagai solusi untuk menggali pola dan informasi tersembunyi dari data. Akan tetapi, sebelum proses analisis dilakukan, sangat penting untuk memahami konteks dan tujuan bisnis terlebih dahulu. Tahap inilah yang disebut Business Understanding.

    Sebagai contoh, dalam pembelajaran data mining sering digunakan Iris Flower Dataset sebagai dataset klasik untuk klasifikasi. Dataset ini berisi data pengukuran bunga iris berdasarkan:
...
### 4. Manfaat Business Understanding
    ...
    * Membantu menghasilkan solusi yang relevan dengan kebutuhan bisnis.
